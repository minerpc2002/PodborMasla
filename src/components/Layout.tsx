...
import { Home, Search, History, Heart, ShieldCheck, User, Gift } from 'lucide-react';
...
export default function Layout() {
  ...
  return (
    <div className="flex min-h-screen flex-col bg-slate-50 dark:bg-zinc-950 text-zinc-900 dark:text-zinc-50 font-sans">
      ...
      <header className="sticky top-0 z-50 w-full bg-slate-50/80 backdrop-blur-xl dark:bg-zinc-950/80 border-b border-zinc-200/50 dark:border-zinc-800/50">
      ...
      <nav className="fixed bottom-6 left-0 right-0 z-50 px-4 pb-safe pointer-events-none">
