...
const productsDB = {
  engine_oil: [
    ...
    { id: 'e10', brand_name: 'Liqui Moly', product_name: 'Molygen New Generation 5W-40', category: 'engine_oil', viscosity: '5W-40', approvals: ['API SN', 'ACEA A3/B4'], description: 'НС-синтетическое моторное масло с фирменным антифрикционным пакетом Molygen.' },
    ...
    { id: 'e12', brand_name: 'Liqui Moly', product_name: 'Synthoil Energy 0W-40', category: 'engine_oil', viscosity: '0W-40', approvals: ['API SN', 'ACEA A3/B4'], description: '100% ПАО-синтетическое моторное масло.' },
    ...
    { id: 'e14', brand_name: 'Liqui Moly', product_name: 'Special Tec V 0W-30', category: 'engine_oil', viscosity: '0W-30', approvals: ['ACEA A5/B5', 'Volvo VCC 95200377'], description: 'НС-синтетическое моторное масло для Volvo.' },
    ...
    { id: 'e17', brand_name: 'Liqui Moly', product_name: 'Top Tec 4200 5W-30', category: 'engine_oil', viscosity: '5W-30', approvals: ['VW 504 00', 'VW 507 00', 'ACEA C3'], description: 'НС-синтетическое моторное масло для VAG.' },
  ...
  atf: [
    ...
    { id: 'a4', brand_name: 'Liqui Moly', product_name: 'Top Tec ATF 1800', category: 'atf', viscosity: 'ATF', approvals: ['Dexron VI', 'Mercon LV'], description: 'НС-синтетическое трансмиссионное масло для АКПП.' },
  ],
  mtf: [
    ...
    { id: 'm3', brand_name: 'Liqui Moly', product_name: 'Hochleistungs-Getriebeoil 75W-90', category: 'mtf', viscosity: '75W-90', approvals: ['API GL-4+'], description: 'Синтетическое трансмиссионное масло.' },
  ],
  dsg: [
    ...
    { id: 'd3', brand_name: 'Liqui Moly', product_name: 'Doppelkupplungsgetriebe-Oil 8100', category: 'dsg', viscosity: '75W', approvals: ['VW G 052 182', 'VW G 052 529'], description: 'НС-синтетическое трансмиссионное масло для DSG.' },
  ],
  cvt: [
